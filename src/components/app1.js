...
export function calculateDistanceFromWebcam(focalLengthPixels, pixelDistanceBetweenEyes, knownWidthMm) {
...
export function calculateFocalLength(pixelDistance, knownDistanceMm, knownWidthMm) {
...
export function calculateDistanceInMm(pixelDistance, knownDistanceInMm, referencePixelDistance) {
...
export function calculateEyeDistanceFromWebcam(pixelDistanceBetweenEyes, knownDistanceInMm, videoWidth, FOV) {
    ...
    const distanceFromCameraMm = fovWidthMm / 2 / Math.tan((FOV / 2) * (Math.PI / 180));
    ...
    if (results.faceLandmarks) {
        for (const landmarks of results.faceLandmarks) {
            ...
            try {
                ...
                const pixelDistanceBetweenEyes = calculatePixelDistance(pointLeft.x, pointLeft.y, pointRight.x, pointRight.y);
                ...
                const distanceFromWebcamMm = calculateDistanceFromWebcam(focalLengthPixels, pixelDistanceBetweenEyes, knownWidthMm);
